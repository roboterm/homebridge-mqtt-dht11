...
#define topic "home/hall/temphum"                     // overall topic
#define temperature_topic "home/hall/temperature"  // temperature topic
#define humidity_topic "home/hall/humidity"        // humidity topic
...
void reconnect() {
    ...
    while (!client.connected()) {
        ...
        if (client.connect("Hall air sensor")) {
            Serial.println("OK");
        } else {
